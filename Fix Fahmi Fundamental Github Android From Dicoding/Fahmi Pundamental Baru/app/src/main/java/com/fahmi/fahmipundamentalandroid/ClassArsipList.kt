...
//
//                val listUsers = ArrayList<Pengguna>() // Menggunakan model Quote sebagai objek dalam ArrayList
...
//                        val pengguna = Pengguna(username, url_usernya, avatarUrl) // Membuat objek Quote dengan username dan avatarUrl
